    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto flex max-w-md items-center justify-center px-4 py-12">
        <Card className="w-full p-8">
          <h1 className="text-2xl font-bold text-foreground">Learner Sign Up</h1>
          <p className="mt-2 text-muted-foreground">Join TutorHub and start learning</p>
